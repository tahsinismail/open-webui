...
class S3VectorClient(VectorDBBase):
    """
    AWS S3 Vector integration for Bayyena Knowledge.
    """
    ...
    def _filter_metadata(
        ...
        # Keep only the first 10 keys, prioritizing important ones based on actual Bayyena metadata
        important_keys = [
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        try:
            ...
            # The Bayyena GetResult expects lists of lists, so we wrap each list
            if all_ids:
                return GetResult(
